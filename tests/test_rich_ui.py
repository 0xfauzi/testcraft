...
from testcraft.adapters.io.rich_cli import RichCliComponents, TESTCRAFT_THEME
...
class TestRichCliComponents:
    ...
    def test_create_coverage_table_simple(self) -> None:
        ...
        table = self.cli.create_coverage_table(self.sample_coverage_data, show_details=False)
    ...
    def test_create_test_results_table(self) -> None:
        ...
        # Verify table has expected columns
        column_headers = [col.header for col in table.columns]
        expected_columns = ["Source File", "Test File", "Status", "Tests Generated", "Pass Rate"]
...
class TestRichUIAdapter:
    ...
    def test_get_user_input_boolean(self, mock_confirm) -> None:
        ...
        result = self.ui.get_user_input("Continue?", input_type="boolean", default=False)
    ...
    def test_get_user_input_string(self, mock_input) -> None:
        ...
        result = self.ui.get_user_input("Enter name:", input_type="string", default="default")
    ...
    def test_error_handling_in_display_methods(self) -> None:
        ...
        with patch.object(self.ui.rich_cli, 'display_error', side_effect=Exception("Test error")):
            with pytest.raises(UIError) as exc_info:
    ...
    def test_run_configuration_wizard(self) -> None:
        ...
        with patch.object(self.ui.rich_cli, 'create_configuration_wizard') as mock_wizard:
...
'''
    ...
    def test_create_beautiful_summary_comprehensive(self) -> None:
        ...
        data = {
            ...
            'coverage_data': {'files': {'test.py': {'line_coverage': 0.9, 'branch_coverage': 0.8}}},
            'test_results': [{'source_file': 'test.py', 'status': 'success', 'tests_generated': 5}],
    ...
    def test_create_beautiful_summary_simple(self) -> None:
        ...
        data = {
            ...
            'coverage_data': {'files': {'module.py': {'line_coverage': 0.85, 'branch_coverage': 0.75}}},
            'test_results': [],
            'recommendations': []
        }
