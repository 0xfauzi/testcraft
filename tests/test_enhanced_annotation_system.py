...
class TestFailingTestExtraction:
    ...
    def test_extract_failing_tests_from_pytest_output(self, refiner_with_enhanced_annotations):
...
AttributeError: 'MagicMock' object has no attribute 'temperature'
        ...
        failing_tests = refiner_with_enhanced_annotations._extract_failing_tests_from_output(pytest_output)
        
        assert len(failing_tests) >= 3
        assert "tests/test_weatherscheduler.py::test_collect_weather_data_happy_path" in failing_tests
        assert "tests/test_weatherscheduler.py::test_collect_weather_data_city_creation" in failing_tests
        assert "tests/test_weatherscheduler.py::test_collect_weather_data_partial_failure" in failing_tests
    
    def test_extract_failing_tests_handles_empty_output(self, refiner_with_enhanced_annotations):
        """Test handling of empty or None output."""
        assert refiner_with_enhanced_annotations._extract_failing_tests_from_output("") == []
        assert refiner_with_enhanced_annotations._extract_failing_tests_from_output(None) == []
    
    def test_extract_failing_tests_handles_no_failures(self, refiner_with_enhanced_annotations):
...
class TestFailureContextExtraction:
    ...
    def test_extract_failure_context_identifies_error_types(self, refiner_with_enhanced_annotations):
...
SyntaxError: invalid syntax (test_file.py, line 42)
        ...
        context = refiner_with_enhanced_annotations._extract_failure_context(pytest_output)
    ...
    def test_extract_failure_context_captures_import_errors(self, refiner_with_enhanced_annotations):
...
ModuleNotFoundError: No module named 'missing_dependency'
    ...
    def test_extract_failure_context_handles_assertion_details(self, refiner_with_enhanced_annotations):
...
class TestEnhancedFixInstructions:
    ...
    def test_generate_enhanced_fix_instructions_with_failing_tests(self, refiner_with_enhanced_annotations):
        ...
        failure_context = {
            "error_types": ["AttributeError: 'MagicMock' object has no attribute 'temperature'"],
        ...
        instructions = refiner_with_enhanced_annotations._generate_enhanced_fix_instructions(
    ...
    def test_generate_enhanced_fix_instructions_with_import_errors(self, refiner_with_enhanced_annotations):
    ...
    def test_generate_enhanced_fix_instructions_with_assertion_errors(self, refiner_with_enhanced_annotations):
        ...
        failure_context = {
            ...
            "key_messages": [],
            "traceback_highlights": ["mock_object.some_method('Actual')", "assert call('Expected')"]
        }
    ...
    def test_generate_enhanced_fix_instructions_handles_empty_context(self, refiner_with_enhanced_annotations):
...
class TestIntegratedAnnotationSystem:
    ...
    @pytest.mark.asyncio
    async def test_annotate_failed_test_uses_enhanced_instructions(self, refiner_with_enhanced_annotations):
...
AttributeError: 'MagicMock' object has no attribute 'value'
    ...
    @pytest.mark.asyncio 
    async def test_annotation_includes_specific_pytest_command(self, refiner_with_enhanced_annotations):
...
FAILED tests/specific_test.py::test_specific_function - ImportError: No module named 'xyz'
            ...
            assert "pytest tests/specific_test.py::test_specific_function -vv --tb=short" in written_content
