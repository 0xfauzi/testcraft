...
class TestSmartFormatterSelection:
    ...
    @patch(
        "testcraft.adapters.io.python_formatters.FormatterDetector.is_ruff_available"
    )
    def test_format_python_content_uses_ruff_when_available(
        self, mock_ruff_available, mock_format_ruff
    ):
    ...
    @patch(
        "testcraft.adapters.io.python_formatters.FormatterDetector.is_isort_available"
    )
    @patch(
        "testcraft.adapters.io.python_formatters.FormatterDetector.is_black_available"
    )
    @patch(
        "testcraft.adapters.io.python_formatters.FormatterDetector.is_ruff_available"
    )
    def test_format_python_content_fallback_to_black_isort(
        self,
        mock_ruff_available,
        mock_black_available,
        mock_isort_available,
        mock_format_black_isort,
    ):
    ...
    @patch(
        "testcraft.adapters.io.python_formatters.FormatterDetector.get_available_formatters"
    )
    @patch(
        "testcraft.adapters.io.python_formatters.FormatterDetector.is_isort_available"
    )
