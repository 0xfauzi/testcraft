...
class TestStateJsonAdapter:
    ...
    def test_get_state_nested_keys(self):
        ...
        # Set up nested state
        self.adapter._state_cache['level1'] = {
            'level2': {
                'level3': 'deep_value'
            }
        }
    ...
    def test_update_state_append_strategy(self):
        ...
        assert self.adapter.get_state('test_list') == ['item1', 'item2', 'item3', 'item4']
    ...
    def test_add_generation_log_entry(self):
        ...
        result = self.adapter.add_generation_log_entry('generate_tests', operation_details)
...
class TestStateJsonAdapterIntegration:
    ...
    def test_full_workflow_simulation(self):
        ...
        # 2. Generate tests
        self.adapter.add_generation_log_entry('generate_tests', {
            'file_path': 'main.py',
            'tests_generated': 3,
            'status': 'success'
        })
        ...
        self.adapter.set_idempotent_decision('main.py', {
            'decision': 'generated',
            'file_hash': 'abc123',
        ...
        # 4. Update file state
        self.adapter.update_state('file_states.main.py', {
            'hash': 'abc123',
