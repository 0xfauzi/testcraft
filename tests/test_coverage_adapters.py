...
class TestTestcraftCoverageAdapter:
    ...
    def test_analyze_coverage_distribution(self):
        ...
        coverage_data = {
            "excellent.py": CoverageResult(line_coverage=0.95, branch_coverage=0.9, missing_lines=[]),
            "good.py": CoverageResult(line_coverage=0.85, branch_coverage=0.8, missing_lines=[1]),
            "fair.py": CoverageResult(line_coverage=0.65, branch_coverage=0.6, missing_lines=[1, 2]),
            "poor.py": CoverageResult(line_coverage=0.45, branch_coverage=0.4, missing_lines=[1, 2, 3]),
            "very_poor.py": CoverageResult(line_coverage=0.25, branch_coverage=0.2, missing_lines=[1, 2, 3, 4])
        }
