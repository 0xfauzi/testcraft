...
@pytest.fixture
def refiner_with_annotation_enabled(mock_refine_port, mock_telemetry_port, mock_writer_port):
...
@pytest.fixture
def refiner_with_annotation_disabled(mock_refine_port, mock_telemetry_port, mock_writer_port):
...
class TestUnrefinableFailureAnnotation:
    ...
    async def test_annotates_on_unrefinable_failure(
        ...
        with patch.object(refiner_with_annotation_enabled, 'run_pytest') as mock_pytest:
            ...
            with patch.object(refiner_with_annotation_enabled, '_is_unrefinable') as mock_unrefinable:
                mock_unrefinable.return_value = {"unrefinable": True, "failure_category": "import_error"}
...
class TestNoChangeFailureAnnotation:
    ...
    async def test_annotates_on_no_change_early_stop(
        ...
        with patch.object(refiner_with_annotation_enabled, 'run_pytest') as mock_pytest:
            ...
            with patch.object(refiner_with_annotation_enabled, '_is_unrefinable') as mock_unrefinable:
                mock_unrefinable.return_value = {"unrefinable": False, "failure_category": "assertion_error"}
...
class TestSyntaxErrorAnnotation:
    ...
    async def test_annotates_on_syntax_error(
        ...
        with patch.object(refiner_with_annotation_enabled, 'run_pytest') as mock_pytest:
            ...
            with patch.object(refiner_with_annotation_enabled, '_is_unrefinable') as mock_unrefinable:
                mock_unrefinable.return_value = {"unrefinable": False, "failure_category": "syntax_error"}
...
class TestAnnotationConfiguration:
    ...
    async def test_annotation_disabled(
        ...
        # Mock pytest to return unrefinable failure
        with patch.object(refiner_with_annotation_disabled, 'run_pytest') as mock_pytest:
            mock_pytest.return_value = {
                "returncode": 1,
                "stdout": "",
                "stderr": "ModuleNotFoundError: No module named 'missing_module'"
            ...
            # Mock _is_unrefinable to return True
            with patch.object(refiner_with_annotation_disabled, '_is_unrefinable') as mock_unrefinable:
                mock_unrefinable.return_value = {"unrefinable": True, "failure_category": "import_error"}
...
class TestAnnotationHelpers:
    ...
    def test_format_fix_instructions_as_todos(self, refiner_with_annotation_enabled):
        ...
        result = refiner_with_annotation_enabled._format_fix_instructions_as_todos(instructions)
...
class TestTelemetryIntegration:
    ...
    async def test_telemetry_records_annotation_added(
        ...
        mock_span = mock_telemetry_port.create_child_span.return_value.__enter__.return_value
