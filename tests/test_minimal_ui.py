...
class TestUIStyleDetection:
    ...
    @patch('sys.stdout.isatty', return_value=True)  # Even if TTY, CI should force minimal
...
class TestEnhancedUIAdapterMinimal:
    ...
    def test_ui_adapter_stores_ui_style(self):
        ...
        console = Console()
        ui = EnhancedUIAdapter(console, enable_rich_logging=False, ui_style=UIStyle.MINIMAL)
        assert ui.ui_style == UIStyle.MINIMAL
        
        ui_classic = EnhancedUIAdapter(console, enable_rich_logging=False, ui_style=UIStyle.CLASSIC)
    ...
    def test_get_renderer_returns_self_for_classic_style(self):
        ...
        console = Console()
        ui = EnhancedUIAdapter(console, enable_rich_logging=False, ui_style=UIStyle.CLASSIC)
        renderer = ui.get_renderer()
...
class TestMinimalRenderer:
    ...
    def test_render_generation_results_single_file_omits_table(self):
        ...
        results = {
            ...
            "refinement_results": [{"test_file": "foo_test.py", "success": True, "duration": 3.2, "tests_generated": 5}],
        }
        renderer.render_generation_results(results, console)
...
class TestClassicImmediateNoDuplication:
    ...
    def test_immediate_mode_results_no_duplicate_summary(self):
        ...
        results = {
            ...
            "refinement_results": [{"test_file": "a.py", "success": True, "duration": 1.0, "tests_generated": 3}],
            "files_written": 1,
            "files_processed": 1,
            "total_duration": 1.0,
        }
