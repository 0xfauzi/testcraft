...
from testcraft.domain.models import AnalysisReport, CoverageResult, GenerationResult, TestGenerationPlan, TestElement, TestElementType
...
class TestJsonReportAdapter:
    ...
    def test_generate_report_generic(self) -> None:
        ...
        report_data = json.loads(result["report_content"])
        assert report_data["verbose_details"] == True
    ...
    def test_coverage_summary_calculation(self) -> None:
        ...
        summary = self.adapter._calculate_coverage_summary(before_coverage, after_coverage)
