...
def demo_clean_tables():
    ...
    # Clean sample data
    files_data = [
        {"file_path": "src/main.py", "status": "completed", "progress": 100.0, "tests_generated": 5, "duration": 2.3},
        {"file_path": "src/auth.py", "status": "active", "progress": 60.0, "tests_generated": 0, "duration": 1.1},
        {"file_path": "src/models.py", "status": "failed", "progress": 30.0, "tests_generated": 0, "duration": 0.8},
        {"file_path": "src/utils.py", "status": "waiting", "progress": 0.0, "tests_generated": 0, "duration": 0.0}
    ]
