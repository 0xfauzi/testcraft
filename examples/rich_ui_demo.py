...
from testcraft.adapters.io.rich_cli import RichCliComponents
...
def demo_progress_indicators() -> None:
    ...
    for i in range(total_files + 1):
        ...
        }, progress_type="bar", task_id=getattr(demo_progress_indicators, '_task_id', None))
        
        if not hasattr(demo_progress_indicators, '_task_id') and hasattr(ui, '_active_progress') and ui._active_progress:
            demo_progress_indicators._task_id = list(ui._active_progress.tasks.keys())[0]
    ...
    config_steps = [
        {
            ...
            'description': 'Configure your AI language model settings',
            'fields': [
                {
                    'name': 'llm_provider',
                    'title': 'LLM Provider',
        ...
        },
        {
            ...
            'description': 'Configure test generation preferences',
            'fields': [
                {
                    'name': 'test_framework',
                ...
                },
                {
                    ...
                    'type': 'number',
                    'description': 'Minimum coverage percentage to maintain',
                    'default': 80.0
                }
            ]
        }
...
def demo_comprehensive_layout() -> None:
    ...
    data = {
        ...
        'test_results': [
            {'source_file': 'src/main.py', 'status': 'success', 'tests_generated': 5, 'pass_rate': 1.0}
        ],
        'recommendations': [
...
def main() -> None:
    ...
    try:
        ...
        finale_panel = ui.rich_cli.console.print("""
