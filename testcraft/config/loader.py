...
class ConfigLoader:
    ...
    def __init__(self, config_file: Optional[Union[str, Path]] = None):
        ...
        self._config_cache: Optional[TestCraftConfig] = None
    ...
    def create_sample_config(self, filepath: Optional[Union[str, Path]] = None) -> Path:
...
"""
    ...
    def get_config_summary(self) -> Dict[str, Any]:
        ...
        return {
            'config_file': str(self._get_config_file_path()) if self._get_config_file_path() else 'None',
            'coverage_thresholds': {
