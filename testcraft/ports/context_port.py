...
class ContextPort(Protocol):
    ...
    def index(
        self, file_path: str | Path, content: str | None = None, **kwargs: Any
    ) -> dict[str, Any]:
        """
    ...
    def retrieve(
        self, query: str, context_type: str = "general", limit: int = 10, **kwargs: Any
    ) -> dict[str, Any]:
        """
    ...
    def get_related_context(
        self, file_path: str | Path, relationship_type: str = "all", **kwargs: Any
    ) -> dict[str, Any]:
        """
