...
from ..ports.telemetry_port import TelemetryPort, SpanKind
...
class AnalyzeUseCase:
        ...
        **kwargs: Any
        ...
        with self._telemetry.create_span(
            ...
            try:
                ...
                reasons = await self._build_processing_reasons(files_to_process, initial_coverage)
    ...
    async def _build_test_presence_info(
        ...
        with self._telemetry.create_child_span("build_test_presence_info") as span:
            ...
            try:
                ...
                raise AnalyzeUseCaseError(
                    f"Test presence analysis failed: {e}",
                    cause=e
                )
    ...
    def _get_file_coverage(self, file_path: Path, coverage_data: Dict[str, Any]) -> float:
    ...
    async def _get_processing_reason(
        ...
        if not has_tests:
            return f"No existing tests found"
