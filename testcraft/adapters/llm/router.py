...
class LLMRouter(LLMPort):
    ...
    def _get_provider_config(self, provider: str) -> Dict[str, Any]:
        ...
        if provider == "openai":
            ...
            provider_config = {
                'deployment_name': self.config.get('azure_openai_deployment', 'o4-mini'),
            ...
            provider_config = {
                'model_id': self.config.get('bedrock_model_id', 'anthropic.claude-3-7-sonnet-v1:0'),
    ...
    async def generate_tests(self, code: str, context: Dict[str, Any]) -> Dict[str, Any]:
