"""
DEPRECATED: Legacy main evaluation adapter - DO NOT USE.

This module has been refactored and split into smaller, focused modules.
Use testcraft.adapters.evaluation.main_adapter.TestcraftEvaluationAdapter instead.

This file is kept for historical reference only and will be removed in a future version.
All functionality has been migrated to:
- acceptance.py: Syntax, import, pytest, and coverage checks
- llm_judge.py: LLM-as-judge evaluation logic
- artifacts.py: Result serialization and storage
- safety.py: Path, shell, and policy validation
- pairwise.py: A/B testing and pairwise comparison
- And other specialized modules in testcraft/adapters/evaluation/
...
warnings.warn(
    "testcraft.adapters.evaluation._legacy.main_adapter_original is deprecated. "
    "Use testcraft.adapters.evaluation.main_adapter instead.",
    DeprecationWarning,
    stacklevel=2
)
        ...
        **kwargs: Any,
        ...
        try:
            ...
            trends = {
                ...
                "acceptance_trends": self._analyze_acceptance_trends(
                    evaluation_history
                ),
    ...
    def run_statistical_significance_analysis(
        ...
        **kwargs: Any,
        ...
        try:
            ...
            analysis_result = self._validate_statistical_results(
            ...
            return {
                ...
                "fallback_analysis": self._fallback_statistical_analysis(
                    evaluation_data, confidence_level
                ),
            }
    ...
    def detect_evaluation_bias(
        ...
        **kwargs: Any,
        ...
        try:
            ...
            history_data = self._format_evaluation_history_for_bias_analysis(
                evaluation_history
            )
                ...
                pipeline_results["variant_evaluations"].append(
                    {
                        ...
                        "summary_stats": self._calculate_variant_summary_stats(
                            variant_results
                        ),
                    }
                )
                    ...
                    pipeline_results["pairwise_comparisons"].append(
                        {
                            ...
                            "summary": self._calculate_pairwise_summary(
                                comparison_results
                            ),
                        }
                    )
                ...
                for variant_eval in pipeline_results["variant_evaluations"]:
                    for result_dict in variant_eval["results"]:
                        ...
                        evaluation_history.append(
                            self._dict_to_evaluation_result(result_dict)
                        )
...
"""
    ...
    def _generate_recommendations(
        self, stats: dict[str, Any], file_results: list[EvaluationResult]
    ) -> list[str]:
    ...
    def _analyze_acceptance_trends(
    ...
    def _format_evaluation_data_for_analysis(
    ...
    def _format_evaluation_history_for_bias_analysis(
    ...
    def _parse_statistical_analysis_response(
    ...
    def _parse_bias_analysis_response(
        self, llm_response: dict[str, Any]
    ) -> dict[str, Any]:
    ...
    def _fallback_statistical_analysis(
        self, evaluation_data: list[dict[str, Any]], confidence_level: float
    ) -> dict[str, Any]:
    ...
    def _validate_statistical_results(
        self, analysis_result: dict[str, Any], evaluation_data: list[dict[str, Any]]
    ) -> dict[str, Any]:
    ...
    def _compute_bias_metrics(
        self, bias_result: dict[str, Any], evaluation_history: list[EvaluationResult]
    ) -> dict[str, Any]:
    ...
    def _generate_test_with_variant(
        self, variant: dict[str, str], test_case: dict[str, str]
    ) -> str:
...
"""
    ...
    def _calculate_variant_summary_stats(
        self, variant_results: list[EvaluationResult]
    ) -> dict[str, Any]:
    ...
    def _dict_to_evaluation_result(
