...
class WriterAppendAdapter:
        ...
        **kwargs: Any
        ...
        try:
            ...
            if not directory_result['success']:
                raise WriterAppendError(f"Failed to create directory: {resolved_path.parent}")
    ...
    def write_test_file(
        ...
        **kwargs: Any
        ...
        try:
            ...
            raise WriterAppendError(f"Failed to write test file {test_path}: {e}") from e
    ...
    def ensure_directory(
        ...
        try:
            ...
            raise WriterAppendError(f"Failed to ensure directory {directory_path}: {e}") from e
