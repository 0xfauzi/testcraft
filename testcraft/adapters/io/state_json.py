...
class StateJsonAdapter:
    ...
    def __init__(self, project_root: Optional[Path] = None, state_file: Optional[str] = None):
        """
    ...
    def get_state(
        ...
        **kwargs: Any
        ...
        try:
            ...
            raise StateJsonError(f"Failed to get state for key '{state_key}': {e}") from e
    ...
    def update_state(
        ...
        **kwargs: Any
        ...
        try:
            ...
            elif merge_strategy == "merge" and isinstance(previous_value, dict) and isinstance(new_value, dict):
            ...
            raise StateJsonError(f"Failed to update state for key '{state_key}': {e}") from e
        ...
        **kwargs: Any
        ...
        try:
            ...
            if isinstance(current, dict):
                def _build_filtered_dict(data: Dict[str, Any], prefix: str) -> Dict[str, Any]:
                    result = {}
            ...
            raise StateJsonError(f"Failed to get all state with prefix '{state_prefix}': {e}") from e
    ...
    def clear_state(
        ...
        **kwargs: Any
        ...
        try:
            ...
            raise StateJsonError(f"Failed to clear state for key '{state_key}': {e}") from e
    ...
    def add_coverage_entry(self, file_path: str, coverage_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return self.update_state(
            f"coverage_history.{file_path}",
            coverage_entry,
            merge_strategy="append"
        )
    
    def add_generation_log_entry(self, operation: str, details: Dict[str, Any]) -> Dict[str, Any]:
    ...
    def set_idempotent_decision(self, decision_key: str, decision_data: Dict[str, Any]) -> Dict[str, Any]:
    ...
    def get_coverage_history(self, file_path: Optional[str] = None) -> Dict[str, Any]:
    ...
    def get_generation_log(self, limit: Optional[int] = None) -> List[Dict[str, Any]]:
