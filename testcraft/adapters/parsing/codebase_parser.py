...
class CodebaseParser:
    ...
    def parse_file(
        ...
        **kwargs: Any
        ...
        try:
            ...
            elements, source_content = self._extract_elements(tree, source_code, file_path)
    ...
    def extract_functions(
        ...
        **kwargs: Any
        ...
        functions = [
            ...
            if elem.type == TestElementType.FUNCTION
        ]
    ...
    def extract_classes(
        ...
        **kwargs: Any
        ...
        classes = [
            elem for elem in elements 
            if elem.type == TestElementType.CLASS
        ]
    ...
    def extract_methods(
        ...
        **kwargs: Any
        ...
        methods = [
            elem for elem in elements 
            if elem.type == TestElementType.METHOD
        ]
        ...
        if class_name:
            ...
            methods = [
                ...
                if method.name.startswith(f"{class_name}.")
            ]
    ...
    def _detect_language(self, file_path: Path, language: Optional[str]) -> str:
    ...
    def _is_external_dependency(self, module_name: str) -> bool:
        ...
        common_third_party = {
            ...
            'fastapi', 'pydantic', 'sqlalchemy', 'click'
        }
