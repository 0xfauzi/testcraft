...
class RefineAdapter:
    ...
    def _payload_to_instructions(self, payload: dict[str, Any]) -> str:
        ...
        if (
            hasattr(self.config, "strict_assertion_preservation")
            and self.config.strict_assertion_preservation
        ):
            ...
            instructions.append(
                "- If test failure indicates production bug, report as suspected_prod_bug"
            )
            instructions.append("")
