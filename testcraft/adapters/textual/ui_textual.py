...
from .widgets import FileTable, StatsPanel, FooterProgress, Notifications
from .events import (
    ProgressUpdated, FileStatusChanged, StatsUpdated, ErrorOccurred,
...
class TextualUIAdapter:
    ...
    def __init__(
        ...
        app: Optional[TestCraftTextualApp] = None,
        transient: bool = True,
    ):
        """
        ...
        self._current_screen: Optional[ModalScreen] = None
        ...
        try:
            ...
            if self._app and not self._transient:
                ...
                self._app.post_message(
                    ProgressUpdated(current, total, message)
                )
            else:
    ...
    def display_file_progress_table(
        ...
        title: str = "File Processing Status"
    ):
