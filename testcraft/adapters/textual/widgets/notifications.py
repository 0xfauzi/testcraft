...
class NotificationWidget(Static):
    ...
    def _render_notification(self) -> None:
        ...
        color, icon = self.SEVERITY_STYLES.get(
            notif.severity, 
            ("white", "•")
        )
...
class Notifications(Vertical):
    ...
    def _add_notification(self, notification: Notification) -> None:
        ...
        if notification.duration > 0:
            timer = self.set_timer(
                ...
                lambda w=widget: self._dismiss_notification(w)
            )
    ...
    def clear_by_severity(self, severity: NotificationSeverity) -> None:
        ...
        to_remove = [
            widget for widget in self._notifications
    ...
    def info(self, message: str, title: Optional[str] = None, **kwargs) -> None:
        """Show an info notification."""
        self.show_notification(
            message, NotificationSeverity.INFO, title, **kwargs
        )
    
    def success(self, message: str, title: Optional[str] = None, **kwargs) -> None:
        """Show a success notification."""
        self.show_notification(
            message, NotificationSeverity.SUCCESS, title, **kwargs
        )
    
    def warning(self, message: str, title: Optional[str] = None, **kwargs) -> None:
        """Show a warning notification."""
        self.show_notification(
            message, NotificationSeverity.WARNING, title, **kwargs
        )
    
    def error(self, message: str, title: Optional[str] = None, **kwargs) -> None:
        """Show an error notification."""
        self.show_notification(
            message, NotificationSeverity.ERROR, title, **kwargs
        )
...
class ToastNotifications(Static):
    ...
    def __init__(self, **kwargs):
        ...
        self._current_toast: Optional[str] = None
    ...
    def show_toast(
        ...
        color, icon = NotificationWidget.SEVERITY_STYLES.get(
            severity,
            ("white", "•")
        )
