    ...
    def compose(self) -> ComposeResult:
        ...
        with Container(id="main-content"):
            ...
            with TabbedContent(id="wizard-tabs"):
                ...
                yield TabPane(
                    "Generation", self._create_generation_tab(), id="tab-generation"
                )
                yield TabPane(
                    "Coverage", self._create_coverage_tab(), id="tab-coverage"
                )
                yield TabPane(
                    "Advanced", self._create_advanced_tab(), id="tab-advanced"
                )
