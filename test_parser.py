...
from testcraft.domain.models import TestGenerationPlan, TestElement, TestElementType
...
def test_parser():
    ...
    test_file = Path('/Users/wumpinihussein/Documents/code/ai/weather-collector/src/weather_collector/config.py')
